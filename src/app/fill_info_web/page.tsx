        ...
        <div className='w-full my-[24px] flex flex-col gap-2 relative'>
            ...
            <div className='w-full lg:w-main p-4 lg:p-0 h-[200px] mx-auto flex flex-col gap-2'>
                <div className='flex justify-between items-center'>
                    <div className='w-[860px] font-extrabold text-[32px] md:text-[48px] lg:text-[56px]'>GLOBAL EVISA APPLICATION FORM</div>
                    <div onClick={() => { router.push(`/`) }} className='border border-transparent px-4 py-2 text-center lg:w-[210px] lg:h-[61px] flex items-center justify-center bg-[#3B7ACC] text-white rounded-2xl hover:bg-white hover:text-[#3B7ACC] hover:border-[#3B7ACC] cursor-pointer transition-all duration-300 ease-in-out'>
                ...
                <div className='w-full flex justify-between relative'>
                    <div className='w-[320px] h-[147px] flex flex-col gap-4 items-center'>
                        ...
                        <span className='font-bold text-[16px] lg:text-[24px] text-center'>Order Information</span>
                    </div>
                    <div className='w-[320px] h-[147px] flex flex-col gap-4 items-center'>
                        ...
                        <span className='font-medium text-[16px] lg:text-[24px] text-center'>Payment</span>
                    </div>
                    <div className='w-[320px] h-[147px] flex flex-col gap-4 items-center'>
                        <div className='w-[80px] h-[80px] rounded-full flex items-center justify-center border border-[#F08921] bg-white z-50'>
                            <span className='font-extrabold text-[28px] leading-[36px] text-[#F08921]'>3</span>
                        </div>
                        <span className='font-medium text-[16px] lg:text-[24px] text-center'>Confirmation</span>
                    </div>
                    <div className='w-[841px] h-[2px] absolute top-[40px] left-[170px] bg-[#D3D3D3] hidden lg:flex'></div>
                </div>
            </div>
            <div className='flex flex-col lg:flex-row lg:justify-between w-full lg:w-main p-4 lg:p-0 mx-auto mt-[100px] lg:mt-[150px]'>
                <div className='w-full flex flex-col lg:w-[690px] gap-[40px]'>
                    <div className='w-full bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded p-8 flex flex-col gap-[10px]'>
                        ...
                        <div className='flex flex-col gap-[8px]'>
                            ...
                            <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                    ...
                                    <span className='text-[12px] lg:text-[16px]'>Please Select</span>
                                </div>
                            ...
                            <div className='w-[45%] flex flex-col gap-[8px]'>
                                ...
                                <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                    <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                        ...
                                        <span className='text-[12px] lg:text-[16px]'>DD/MM/YYYY</span>
                                    </div>
                                    <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.3513 6.3335L7.64882 6.3335C6.10524 6.3335 5.1435 8.00793 5.92127 9.34124L8.27252 13.372C9.04428 14.695 10.9559 14.695 11.7276 13.372L14.0789 9.34124C14.8567 8.00793 13.8949 6.3335 12.3513 6.3335Z" stroke="#545454" strokeLinejoin="round" />
                                    </svg>
                        ...
                        <div className='flex flex-col gap-[12px] lg:flex-row lg:w-[500px] lg:justify-between'>
                    ...
                    <div className='w-full bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded p-8 flex flex-col gap-[24px]'>
                        <span className='text-black font-extrabold text-[24px] leading-[32px]'>APPLICATION NO.</span>
                        <div className='flex justify-between'>
                            <div className='w-[45%] lg:w-[276px] flex flex-col gap-[16px]'>
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                    ...
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            ...
                                            <span className='text-[12px] lg:text-[16px]'>Enter value</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            ...
                                            <div className='flex gap-1 items-center'>
                                                <span className='text-[12px] lg:text-[16px]'>+84</span>
                                                <IoIosArrowDown />
                                                <span className='text-[12px] lg:text-[16px]'>Enter a value</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='w-[45%] lg:w-[276px] flex flex-col gap-[16px]'>
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                        <span className='text-[#272727] font-semibold text-[16px] leading-[24px] line-clamp-1'>Day of Birth</span>
                                    </div>
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                        <span className='text-[#272727] font-semibold text-[16px] leading-[24px] line-clamp-1'>Email Address</span>
                                    </div>
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                        <span className='text-[#272727] font-semibold text-[16px] leading-[24px] line-clamp-1'>Country of Residency</span>
                                    </div>
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                        <span className='text-[#272727] font-semibold text-[16px] leading-[24px] line-clamp-1'>Appointment Location</span>
                                    </div>
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col gap-[8px]'>
                                    <div className='flex gap-1'>
                                        <span className='text-[#272727] font-semibold text-[16px] leading-[24px] line-clamp-1'>Expired Date</span>
                                    </div>
                                    <div className='w-full h-[40px] border border-[#7F7F7F] rounded-md flex items-center justify-between px-2'>
                                        <div className='flex gap-4 items-center text-[#A9A9A9]'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='flex flex-col gap-[12px] lg:flex-row lg:gap-[24px]'>
                            <div className='w-full lg:w-[276px] flex flex-col gap-1'>
                                <div className='flex gap-1'>
                                ...
                                <div className='w-full h-[160px] bg-[#FBEADA] rounded-lg border border-[#7F7F7F] flex flex-col gap-1 items-center justify-center'>
                    ...
                    <div className='p-8 w-full lg:h-[80px] bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded flex items-center justify-center'>
                        <div className='lg:w-[576px] h-[40px] flex gap-2 lg:justify-between items-center'>
                    ...
                    <div className='p-8 w-full lg:h-[360px] bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded flex items-center justify-center'>
                        <div className='lg:w-[576px] lg:h-[292px] flex flex-col justify-between'>
                    ...
                    <div className='flex flex-col gap-[16px]'>
                        <div className='w-full flex gap-2 items-center' onClick={() => setConfirm1(prev => !prev)}>
                            {
                                confirm1 ?
                        ...
                        <div className='w-full flex gap-2 items-center' onClick={() => setConfirm2(prev => !prev)}>
                            {
                                confirm2 ?
                                    <svg className='cursor-pointer' width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.5" width="24" height="24" rx="4" fill="#3B7ACC" />
                ...
                <div className='w-full lg:w-[440px] lg:h-[880px] bg-[#FFFCF7] border-2 border-dashed border-[#DA857F] rounded p-8 flex flex-col items-center gap-[24px]'>
                    ...
                    <div className='flex justify-between w-full'>
                        ...
                        <span className='text-right'>DD/MM/YYYY</span>
                    </div>
                    <div className='flex justify-between w-full'>
