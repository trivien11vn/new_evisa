        ...
        <div className='w-full my-[24px] flex flex-col gap-2 relative'>
            ...
            <div className='w-full lg:w-main p-4 lg:p-0 h-[200px] mx-auto flex flex-col gap-2'>
                <div className='flex items-center'>
                    <div className='w-[860px] font-extrabold text-[32px] md:text-[48px] lg:text-[56px]'>GLOBAL EVISA ORDER CONFIRMATION</div>
                </div>
                <div className='w-full flex justify-between relative'>
                    ...
                    <div className='w-[320px] h-[147px] flex flex-col gap-4 items-center'>
                        ...
                        <span className='font-thin text-[16px] lg:text-[24px] text-[#000000]'>Payment</span>
                    </div>
                    <div className='w-[320px] h-[147px] flex flex-col gap-4 items-center'>
                        ...
                        <span className='font-bold text-[16px] lg:text-[24px] leading-[36px]'>Confirmation</span>
                    </div>
                    <div className='w-[841px] h-[2px] absolute top-[40px] left-[170px] bg-[#D3D3D3] hidden lg:flex'></div>
                </div>
            </div>
            <div className='w-full lg:w-main p-4 lg:p-0 mx-auto flex mt-[100px] items-end'>
                <div className='flex flex-col gap-6'>
                    <span className='font-extrabold text-[28px] md:text-[32px] lg:text-[40px] underline'>YOUR ORDER WAS CREATED SUCCESSFULLY!</span>
                    ...
                    <div className='lg:w-[690px] lg:h-[650px] p-4 border border-dashed border-[#DA857F] rouded bg-[#FFFCF7]'>
                    ...
                    <div className='mx-auto px-4 py-2 lg:p-0 lg:w-[288px] lg:h-[48px] bg-[#F08921] text-white rounded-2xl flex items-center justify-center'>
