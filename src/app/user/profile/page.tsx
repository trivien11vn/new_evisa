  ...
  return (
    <div className='flex flex-col gap-[24px] w-full'>
        <div className='flex flex-col gap-[20px]'>
            ...
            <div className='w-full lg:h-[128px] rounded-2xl bg-[#E5E5E5] flex p-4 justify-between'>
                ...
                <div className='w-[70%] flex flex-col justify-between py-2'>
                    ...
                    <span className='w-full lg:w-[400px] text-[14px] leading-5 text-[#272727]'>Upload JPG, GIF or PNG image. 300 x 300 is recommended.</span>
                </div>
            </div>
        </div>
        ...
        <div className='flex flex-col gap-[20px]'>
            ...
            <div className='flex flex-col sm:flex-row justify-between w-full'>
                ...
                <div className='w-full sm:w-[48%] flex flex-col gap-[8px]'>
                    <span className='font-bold text-[16px] leading-[24px]'>Phone Number:</span>
        ...
        <div className='w-full flex justify-end'>
            <div className='uppercase bg-[#3B7ACC] border border-[#3B7ACC] px-4 py-2 w-fit rounded-2xl text-white'>
                Update Profile
            </div>
        </div>
    </div>
