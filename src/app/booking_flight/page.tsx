    ...
    return (
        <div className='w-full my-[24px] flex flex-col gap-8 relative'>
            <div className='w-full lg:w-main p-4 lg:p-0 mx-auto flex flex-col gap-8'>
                <span className='font-extrabold text-[32px] md:text-[48px] lg:text-[56px]'>BOOK YOUR FLIGHT!</span>
                <div className='flex items-center'>
                    <div className='w-[80px] h-[20px] bg-[#F08921] absolute left-0 hidden xl:flex'></div>
                    <span className='font-normal text-[24px] md:text-[28px] lg:text-[32px]'>Where do you wanna go?</span>
                </div>
                <div className="w-full bg-[#3B7ACC] flex flex-col items-center gap-8 px-16 py-8">
                    ...
                    <button onClick={() => { router.push(`/${path.SEARCH_FLIGHT}`) }} className="bg-[#F08921] border-2 border-white rounded-xl px-6 py-2 text-white text-sm md:text-md lg:text-lg font-bold flex gap-8 items-center">
                        <span>SEARCH YOUR FLIGHT</span>
                        <LuMoveUpRight />
                    </button>
                </div>
                <div className='flex flex-col gap-[12px] lg:flex-row lg:justify-between lg:items-center'>
                    <div className='flex flex-col gap-4'>
                        <div className='w-[60px] h-[12px] md:w-[80px] md:h-[16px] lg:w-[100px] lg:h-[20px] bg-[#FFA852]'></div>
                        <span className='font-extrabold text-[28px] md:text-[32px] lg:text-[40px] underline text-[#272727]'>TOP DESTINATIONS</span>
                        <span className='font-extrabold text-[16px] md:text-[20px] lg:text-[24px] text-[#545454]'>BEST LOCATIONS</span>
                    </div>
                    <span className='lg:w-[596px] lg:text-right font-normal text-[12px] md:text-[14px] lg:text-[16px] text-[#272727]'>
                ...
                <div className='flex'>
                    <div className='w-1/2'>
                        <img src={scenery4} className='w-full h-full lg:h-[640px] object-cover' />
                    </div>
                    <div className='w-1/2 flex flex-col gap-4 items-end'>
                        <div className='w-[60px] h-[12px] md:w-[80px] md:h-[16px] lg:w-[100px] lg:h-[20px] bg-[#FFA852]'></div>
                        <span className='font-extrabold text-[28px] md:text-[32px] lg:text-[40px] underline text-[#272727] text-right'>HOW IT WORKS</span>
                        <span className='font-extrabold text-[16px] md:text-[20px] lg:text-[24px] text-[#545454] text-right'>BEST LOCATIONS</span>
                        <div className='flex flex-col gap-[16px] items-end'>
                            <div className='w-[80%] flex gap-[12px] lg:gap-[40px] items-start transition-all duration-300 ease-in-out hover:bg-blue-200 hover:p-2 rounded-md'>
                                <div className='min-w-[32px] h-[32px] lg:min-w-[64px] lg:h-[64px] text-white bg-[#3B7ACC] rounded-lg flex items-center justify-center'>
                                    <svg className="w-[16px] h-[15px] lg:w-[32px] lg:h-[30px]" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex flex-col gap-2'>
                                    <span className='font-bold text-[12px] md:text-[16px] lg:text-[20px]'>Find your destination</span>
                                    <span className='font-normal text-[10px] md:text-[12px] lg:text-[14px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                                </div>
                            </div>
                            <div className='w-[80%] flex gap-[12px] lg:gap-[40px] items-start transition-all duration-300 ease-in-out hover:bg-blue-200 hover:p-2 rounded-md'>
                                <div className='min-w-[32px] h-[32px] lg:min-w-[64px] lg:h-[64px] text-white bg-[#3B7ACC] rounded-lg flex items-center justify-center'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <span className='font-bold text-[12px] md:text-[16px] lg:text-[20px]'>Book a ticket</span>
                                    <span className='font-normal text-[10px] md:text-[12px] lg:text-[14px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                                </div>
                            </div>
                            <div className='w-[80%] flex gap-[12px] lg:gap-[40px] items-start transition-all duration-300 ease-in-out hover:bg-blue-200 hover:p-2 rounded-md'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <span className='font-bold text-[12px] md:text-[16px] lg:text-[20px]'>Make payment</span>
                                    <span className='font-normal text-[10px] md:text-[12px] lg:text-[14px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                                </div>
                            </div>
                            <div className='w-[80%] flex gap-[12px] lg:gap-[40px] items-start transition-all duration-300 ease-in-out hover:bg-blue-200 hover:p-2 rounded-md'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <span className='font-bold text-[12px] md:text-[16px] lg:text-[20px]'>Explore destinations</span>
                                    <span className='font-normal text-[10px] md:text-[12px] lg:text-[14px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className='flex flex-col gap-[12px] lg:flex-row lg:justify-between lg:items-center'>
                    <div className='flex flex-col gap-4'>
                        <div className='w-[60px] h-[12px] md:w-[80px] md:h-[16px] lg:w-[100px] lg:h-[20px] bg-[#FFA852]'></div>
                        <span className='font-extrabold text-[28px] md:text-[32px] lg:text-[40px] underline text-[#272727]'>TOUR PACKAGES</span>
                        <span className='font-extrabold text-[16px] md:text-[20px] lg:text-[24px] text-[#545454] uppercase'>Our Destination List</span>
                    </div>
                    <span className='w-[596px] lg:text-right font-normal text-[12px] md:text-[14px] lg:text-[16px] text-[#272727]'>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                    </span>
                </div>
