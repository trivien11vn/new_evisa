                            ...
                            <div className='flex flex-col gap-[40px]'>
                                <div className='w-full rounded-b-xl border border-[#2F62A3] px-4 py-6 flex flex-col gap-[4px] sm:gap-[8px] md:gap-[12px] lg:gap-[24px]'>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        <div className='w-[40%] p-1 md:p-2 lg:p-4 flex gap-4 rounded-md border border-[#7F7F7F]'>
                                            ...
                                            <div className='w-full flex flex-col gap-2'>
                                                <span className='w-full font-semibold text-[8px] sm:text-[10px] md:text-[12px] lg:text-[16px] xl:text-[18px]'>
                                                    Tan Son Nhat International Airport
                                                </span>
                                                <div className='flex flex-wrap gap-[8px] sm:gap-[12px] md:gap-[16px] lg:gap-[24px]'>
                                                    <span className='text-[8px] sm:text-[10px] md:text-[12px] lg:text-lg xl:text-xl'>
                                                        Terminal 3
                                                    </span>
                                                    <span className='text-[8px] sm:text-[10px] md:text-[12px] lg:text-lg xl:text-xl'>
                                                        Singapore
                                        ...
                                        <div className='w-[10%]'>
                                            <svg className='w-full' viewBox="0 0 86 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='flex justify-between items-start'>
                                        <div className='flex gap-[24px] items-center'>
                                            <span className='line-through font-semibold text-[8px] sm:text-[10px] md:text-[12px] lg:text-[16px] text-[#7F7F7F] font-montserrat'>2,599,000 VND</span>
                                            <span className='text-[#3B7ACC] font-extrabold text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px]'>2,399,000 VND</span>
                                        </div>
                                        <div className='flex flex-col gap-[8px] items-end'>
                                            <div className='py-1 px-2 sm:px-4 md:px-8 lg:px-20 lg:py-2 rounded-xl w-fit h-fit bg-[#F08921]'>
                                                <span className='font-extrabold text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] text-white'>SELECT</span>
                                            </div>
                                            <span className='font-semibold text-[8px] sm:text-[10px] md:text-[12px] lg:text-[16px] text-[#2F62A3] underline'>View Details</span>
                                        </div>
                                    </div>
                                </div>
